...
export const CloverInfoPage = () => {
  ...
  const updateForm = <K extends keyof FormData>(k: K, v: FormData[K]) =>
    setFormData((p) => ({ ...p, [k]: v }));
  ...
  const isStepValid = (): boolean => {
    switch (step) {
      case 1:
        return !!formData.jobType && !!formData.jobDetail;
      case 2:
        return !!formData.degree && !!formData.educationGroup;
      case 3:
        return !!formData.assetBase && !!formData.assetLevel;
      case 4:
        return !!formData.height && formData.photos.length >= 2;
      case 5:
        return formData.introduction.length >= 50;
      default:
        return false;
    }
  };
  ...
  const jobDetailOptions: Record<string, { value: string; label: string }[]> = {
    professional: [
    ...
    employee: [
      ...
      { value: 'it', label: 'IT 기업' },
      { value: 'finance', label: '금융권' },
    ],
    public: [
      { value: 'grade4', label: '4급 이상' },
      { value: 'grade7', label: '7급' },
      { value: 'grade9', label: '9급' },
    ],
    business: [
      { value: 'ceo', label: 'CEO' },
      { value: 'startup_ceo', label: '스타트업 대표' },
  ...
  for (let h = 150; h <= 200; h++) {
    heightOptions.push({ value: h.toString(), label: `${h}cm` });
  }
          ...
          <div className="slide-up">
            ...
            <div className="mt-24 mb-24">
              ...
              <CardOptionGrid
                ...
                onChange={(v) => {
                  updateForm('jobType', v);
                  updateForm('jobDetail', '');
                }}
              />
            </div>
            {formData.jobType && (
      ...
      case 3:
        return (
          <div className="slide-up">
            ...
            <NoticeBox>
              자산 정보는 매칭 품질 향상에만 사용되며, 구체적인 금액은 공개되지
              않습니다.
            </NoticeBox>
            <div className="mt-24 mb-24">
        ...
        return (
          <div className="slide-up">
            ...
            <div>
              ...
              <HelperText>최소 2장, 최대 6장 등록 가능</HelperText>
              <div className="mt-12">
                <PhotoUploadGrid
      ...
      case 5:
        return (
          <div className="slide-up">
            ...
            />
            <NoticeBox>
              • 평소 어떤 사람인지 솔직하게 써주세요
              <br />• 연락처, SNS 계정 등은 기재하지 마세요
            </NoticeBox>
          </div>
        );
      default:
  ...
  return (
    <div className="screen">
      <Header title="클로버 정보" onBack={handleBack} />
