...
export const BasicInfoPage = () => {
  ...
  const isStepValid = (): boolean => {
    switch (step) {
      ...
      case 8:
        return formData.nickname.length >= 2 && formData.nickname.length <= 10;
      default:
        return false;
    }
  };
  ...
  const filteredLocations = searchQuery
    ? allLocations.filter((l) => l.main.includes(searchQuery))
    : allLocations;
      ...
      case 1:
        return (
          <div className="slide-up">
            ...
            />
            <HelperText>변경할 수 없으니 신중하게 선택해주세요</HelperText>
          </div>
        );
      case 2:
        return (
          <div className="slide-up">
            ...
            <div className="box-input-group">
              <BoxInput
                ...
                onChange={(v) =>
                  updateForm('birthYear', v.replace(/[^\d]/g, '').slice(0, 4))
                }
                maxLength={4}
              />
              <BoxInput
                ...
                onChange={(v) =>
                  updateForm('birthMonth', v.replace(/[^\d]/g, '').slice(0, 2))
                }
                maxLength={2}
              />
              <BoxInput
                ...
                onChange={(v) =>
                  updateForm('birthDay', v.replace(/[^\d]/g, '').slice(0, 2))
                }
                maxLength={2}
              />
            </div>
            <HelperText>만 19세 이상만 가입 가능합니다</HelperText>
          </div>
        );
      case 3:
        return (
          <div className="slide-up">
            ...
            <div className="mb-24">
              ...
              <ChipGroup
                ...
                onChange={(vals) =>
                  updateForm('region', vals[vals.length - 1] || '')
                }
                maxSelect={1}
              />
            </div>
      ...
      case 4:
        return (
          <div className="slide-up">
            ...
            <SelectionList
              options={[
                { value: 'yes', label: '자주 마셔요' },
                { value: 'sometimes', label: '가끔 마셔요' },
                { value: 'no', label: '안 마셔요' },
              ]}
        ...
        return (
          <div className="slide-up">
            ...
            <div className="interests-header">
              <HelperText>최소 3개, 최대 6개까지 선택 가능해요</HelperText>
              <span className="interests-counter">
                선택된 관심사: {formData.interests.length}/6
              </span>
            </div>
      ...
      case 8:
        return (
          <div className="slide-up">
            ...
            <NoticeBox>
              닉네임은 가입 후에도 변경할 수 있어요. 부적절한 닉네임은 서비스
              이용에 제한이 있을 수 있어요.
            </NoticeBox>
          </div>
        );
  ...
  return (
    <div className="screen">
      <Header title="기본 정보" onBack={handleBack} />
